    ...
    return (
        <div className="p-4">
            <div className="relative h-64 w-full flex bg-main rounded-md cursor-pointer bg-cover" style={{ backgroundImage: `url(${img})` }}>
                ...
                <img className="absolute right-2 top-1 rounded h-20 w-20" src={logo} alt="Logo" />

                <div className="text-white text-center w-full mt-36 text-4xl md:text-4xl" style={{ textShadow: "0px 0px 3px #000000" }}>
                    {title}
