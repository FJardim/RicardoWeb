...
const Recipes = () => {
  ...
  const [{ recipes, numberOfPages, loading }] = useRecipes({
    params: { ...recipesFilters },
  ...
  return (
    <div className="">
      ...
      <div className="container md:p-8">{/* <ButtonSupr /> */}</div>
      <div className="p-6">
      ...
      >
        <ModalContainer onClose={() => setShowModalMenu(false)}>
          <div className="rounded-lg shadow">
            <CategoriesRecipes
              onClickCategory={handleCategory}
              values={recipesFilters?.categoryIds}
            />
          </div>
          <div className="p-4 mt-6 bg-white m-auto md:w-40 rounded-lg shadow">
            ...
            <div className="flex items-center space-between flex-wrap">
              ...
              {recipesFilters?.rating && (
                <button
                  className="bg-main rounded-xl text-white px-4 py-1"
                  onClick={() => {
                    setRecipesFilters((oldRecipesFilters) => {
                      return {
                        ...oldRecipesFilters,
